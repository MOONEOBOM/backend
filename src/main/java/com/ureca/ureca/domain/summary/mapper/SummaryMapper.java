...
public interface SummaryMapper {
  ...
  List<SummaryItem> selectSummaries(@Param("userId") Long userId, @Param("limit") int limit,
      @Param("cursor") Long cursor);

  // 최근 조회
  List<SummaryItem> selectRecentSummaries(@Param("userId") Long userId, @Param("limit") int limit);
